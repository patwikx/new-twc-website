...
export default function CartPage() {
  const { items, removeFromCart, updateItem, clearCart, getItemDetails, getCartSubtotal } = useCartStore();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-6">
            {currentItems.map((item, index) => {
              ...
              const itemTotal = room.price * nights;
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 space-y-4">
                    <div>
                      <p className="text-xs text-orange-500 uppercase tracking-widest">{property.name}</p>
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-white/5">
                      <p className="text-neutral-400 text-sm">
                        ₱{room.price.toLocaleString()} x {nights} night{nights > 1 ? "s" : ""}
                      </p>
