...
import { LOCAL_EXPERIENCES, LocalExperience } from "@/lib/mock-data";
...
export default function ExperiencesPage() {
  ...
  const filteredExperiences = activeCategory === "All" 
    ? LOCAL_EXPERIENCES 
    : LOCAL_EXPERIENCES.filter(exp => exp.category === activeCategory);
...
function ExperienceCard({ experience, index }: { experience: LocalExperience; index: number }) {
  const categoryColors: Record<LocalExperience["category"], string> = {
  ...
  return (
    ...
    >
      ...
      <div className="aspect-[4/3] relative overflow-hidden">
        ...
        {/* Category Badge */}
        <div className={`absolute top-4 right-4 ${categoryColors[experience.category]} text-white text-[10px] uppercase tracking-widest px-3 py-1`}>
          {experience.category}
        </div>
      </div>
